  ...
  return (
    <div className="w-full max-w-lg mx-auto py-8 px-6 flex flex-col items-center justify-center bg-white">
      ...
      <form
        ...
        className="w-full flex flex-col gap-3 border border-slate-400/60 shadow-glow-4side px-8 sm:px-10 py-9 rounded-3xl bg-white shadow-xl shadow-slate-200/50 font-sans"
      >
