...
export const StatsBar: React.FC<StatsBarProps> = ({
  ...
  const formatTime = (seconds: number) => {
    ...
    return remSecs > 0 ? `${mins} phút ${remSecs}s` : `${mins} phút`
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 select-none font-['Be_Vietnam_Pro']">
      ...
      <div className="bg-white rounded-2xl border border-slate-400/60 p-5 shadow-glow-4side hover:shadow-glow-4side-lg transition-all duration-300 flex items-center gap-4">
