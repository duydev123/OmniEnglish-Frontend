...
export const BulkEditModal: React.FC<BulkEditModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-6 bg-slate-900/25 backdrop-blur-[2px] font-['Be_Vietnam_Pro'] select-none">
      <div className="bg-white rounded-3xl w-full max-w-5xl shadow-glow-4side-lg scale-100 animate-in zoom-in-95 duration-200 border border-slate-400/60 overflow-hidden flex flex-col h-[90vh]">
        {/* Header */}
