...
export const EditWordModal: React.FC<EditWordModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-4 bg-slate-900/25 backdrop-blur-[2px] font-['Be_Vietnam_Pro'] select-none">
      <div className="bg-white rounded-3xl w-full max-w-xl shadow-glow-4side-lg scale-100 animate-in zoom-in-95 duration-200 border border-slate-400/60 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
